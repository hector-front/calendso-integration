...
export default function Shell(props) {
    ...
    return session && (
        <div>
            <div className="bg-gradient-to-b from-green-600 via-green-600 to-green-300 pb-32">
                            ...
                            <div className="flex items-center justify-between h-16 px-4 sm:px-0">
                                <div className="flex items-center">
                                    <div className="flex-shrink-0">
                                        <img className="h-6" src="/logo-babafi.svg" alt="Calendso" />
                                    </div>
                                    <div className="hidden md:block">
                                        <div className="ml-10 flex items-baseline space-x-4">
                                            <Link href="/">
                                                <a className={router.pathname == "/" ? "bg-green-500 transition-colors duration-300 ease-in-out text-white px-3 py-2 rounded-md text-sm font-medium" : "text-white hover:bg-green-500 transition-colors duration-300 ease-in-out hover:text-white px-3 py-2 rounded-md text-sm font-medium"}>Dashboard</a>
                                            </Link>
                                            {/* <Link href="/">
                                                <a className={router.pathname.startsWith("/bookings") ? "bg-green-500 transition-colors duration-300 ease-in-out text-white px-3 py-2 rounded-md text-sm font-medium" : "text-white hover:bg-green-500 transition-colors duration-300 ease-in-out hover:text-white px-3 py-2 rounded-md text-sm font-medium"}>Bookings</a>
                                            </Link> */}
                                            <Link href="/availability">
                                                <a className={router.pathname.startsWith("/availability") ? "bg-green-500 transition-colors duration-300 ease-in-out text-white px-3 py-2 rounded-md text-sm font-medium" : "text-white hover:bg-green-500 transition-colors duration-300 ease-in-out hover:text-white px-3 py-2 rounded-md text-sm font-medium"}>Availability</a>
                                            </Link>
                                            <Link href="/integrations">
                                                <a className={router.pathname.startsWith("/integrations") ? "bg-green-500 transition-colors duration-300 ease-in-out text-white px-3 py-2 rounded-md text-sm font-medium" : "text-white hover:bg-green-500 transition-colors duration-300 ease-in-out hover:text-white px-3 py-2 rounded-md text-sm font-medium"}>Integrations</a>
                                            </Link>
                                            <Link href="/settings/profile">
                                                <a className={router.pathname.startsWith("/settings") ? "bg-green-500 transition-colors duration-300 ease-in-out text-white px-3 py-2 rounded-md text-sm font-medium" : "text-white hover:bg-green-500 transition-colors duration-300 ease-in-out hover:text-white px-3 py-2 rounded-md text-sm font-medium"}>Settings</a>
                                            </Link>
                                        </div>
                                    </div>
                                </div>
